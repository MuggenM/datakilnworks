...
| **Orchestration & Scheduling** | ✅ Databricks Workflows | ✅ Tasks & Streams | ✅ **Native Cron + event triggers, retries, timeouts, parameters, repair runs, alerts, a drag-to-edit task graph and a live run page coloured by result** (tasks run sequentially) | 🏆 **Databricks / Snowflake** |
